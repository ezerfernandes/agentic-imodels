...
MODEL_CONFIG = {
    ...
    "HingeGAMRegressor": ("HingeGAM_10bp", "agentic_imodels.hinge_gam", "honest", "HingeGAM_10bp", "Pure Lasso on hinge features with ten breakpoints.", "unmeasured-after-fix", "predict computes exactly the displayed form."),
