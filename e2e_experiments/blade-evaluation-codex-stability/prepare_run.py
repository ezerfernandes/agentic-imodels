...
_ORIGINAL_CODEX_DIR = os.path.join(
    SCRIPT_DIR, "..", "blade-evaluation-codex", "outputs_standard_run1"
)
if os.path.isdir(_BLADE_DIR):
    DATASETS_DIR = _BLADE_DIR
elif os.path.isdir(_SIBLING_DIR):
    DATASETS_DIR = _SIBLING_DIR
elif os.path.isdir(_ORIGINAL_CODEX_DIR):
    DATASETS_DIR = _ORIGINAL_CODEX_DIR
else:
